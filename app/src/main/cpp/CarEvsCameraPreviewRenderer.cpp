...
// TODO need to define EGL_EGLEXT_PROTOTYPES in order to use egl specific components
#define EGL_EGLEXT_PROTOTYPES

// TODO need to define GL_GLEXT_PROTOTYPES in order to use glext specific components
...
const char kClassName[] = "se/cpacsystems/carevscamera/GLES20CarEvsCameraPreviewRenderer";
